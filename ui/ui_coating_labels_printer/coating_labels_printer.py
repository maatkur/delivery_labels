...
################################################################################
## Form generated from reading UI file 'ui_coating_labels_printer.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/newPrefix/menu.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"border-radius: 10px")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/newPrefix/procurar.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/newPrefix/apagar.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/newPrefix/imprimir.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/newPrefix/usuarios.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/newPrefix/numero-de-rastreio.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/newPrefix/reset-password.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"color: black;")
        ...
        icon8 = QIcon()
        icon8.addFile(u":/newPrefix/subtrair.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"color: black;")
        ...
        icon9 = QIcon()
        icon9.addFile(u":/newPrefix/adicionar.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"border-radius: 10px;")
        ...
        self.verticalLayout_5.addWidget(self.reprint_frame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Caixas", None));
